...
function update_user($fname, $lname, $username, $password, $id)
{ //update
    $connect = db_connect();
...
function add_item($name, $price, $desc)
{
    $result = db_connect()->query("INSERT INTO items(item_name,item_price,item_desc)VALUES('$name','$price','$desc')");
}

// function get_all_unpaid_orders(){
//     $sql = "SELECT * FROM cart INNER JOIN items ON cart.item_id = items.item_id WHERE cart.status = 'NOT PAID'";
...
// function get_all_paid_orders(){
//     $sql = "SELECT * FROM cart INNER JOIN items ON cart.item_id = items.item_id WHERE cart.status = 'PAID'";
//     $result = db_connect()->query($sql);
...
function get_all_orders($status)
{
    $sql = "SELECT * FROM cart INNER JOIN items ON cart.item_id = items.item_id 
